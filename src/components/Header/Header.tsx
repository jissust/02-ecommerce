    ...
    <nav className="w-full sm:h-[80px] bg-sky-500 text-white">
      <div className="container block sm:flex mx-auto h-full p-5 sm:p-0">
        <div className="relative grow grid items-center justify-center sm:justify-start">
          ...
          <button
            className="absolute top-0 right-0 px-5 block sm:hidden"
            onClick={showHideMenu}
          >
            <BarsIcon color={"#FFFFFF"} />
          </button>
        </div>
        <div
          className={`grow items-center py-5 sm:py-0 ${
            hideMenu ? "hidden" : ""
          }  sm:grid `}
        >
          <Search />
        ...
        <div
          className={`grow items-center justify-items-end ${
            hideMenu ? "hidden" : ""
          } sm:grid`}
        >
