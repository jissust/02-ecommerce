...
function Header() {
  const [hideMenuUser] = useState(true);
  ...
  const showHideMenuResponsive = () => {
    setHideMenuResponsive((prevState) => !prevState);
  };

  return (
    <nav className="bg-gray-500 fixed top-0 w-full z-[20]">
        ...
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <button
              ...
              aria-expanded="false"
              onClick={showHideMenuResponsive}
            >
